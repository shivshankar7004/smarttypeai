...
import { getRandomWord } from "../app/api/randomWords";
...
const TypingTest = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6">
      <h1 className="text-3xl font-bold mb-6">General Typing Test</h1>
      ...
      <Link href="/services" className="mt-4 bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600">
        Try AI-Driven Typing Test
    </Link>
      </div>
